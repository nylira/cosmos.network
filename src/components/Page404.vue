  ...
  <page-split>
    ...
    <article-body>
      ...
      <ul>
        ...
        <li><router-link :to="'/events'">Conferences</router-link></li>
        <li><router-link :to="'/hackatom'">Hackathon</router-link></li>
        <!--<li><router-link :to="'/validators'">Validator Program</router-link></li>-->
