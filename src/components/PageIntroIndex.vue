...
.parts
  ...
  part(title='Benefits of Cosmos'): text-container
    h2 Interoperability
    .image: img(src="../assets/images/ex_dist_exchange.png")
    ...
    h2 Scalability
    .image: img(src="../assets/images/ex_evm_sharding.png")
    ...
    h2 Upgradability
    .image: img(src="../assets/images/ex_evm_upgrading.png")
    ...
    h2 Decentralization
    .image: img(src="../assets/images/ex_network.png")
