    ...
    .section-home__main
      .cosmos-panels
        .cosmos-panel
          .cosmos-panel__image
            img.cosmos-panel__img(
              src="@/assets/images/diagrams/panel-interoperability.png")
          .cosmos-panel__text
        ...
        .cosmos-panel
          .cosmos-panel__image
            img.cosmos-panel__img(
              src="@/assets/images/diagrams/panel-scalability.png")
          .cosmos-panel__text
        ...
        .cosmos-panel
          .cosmos-panel__image
            img.cosmos-panel__img(
              src="@/assets/images/diagrams/panel-developer-friendly.png")
          .cosmos-panel__text
